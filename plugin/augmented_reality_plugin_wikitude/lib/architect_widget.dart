...
class ArchitectWidget extends StatefulWidget {
  ...
  Future<void> load(String url, OnWorldLoaded worldLoaded,
      OnWorldLoadFailed worldLoadFailed) async {
    assert(url != null);
  ...
  Future<void> setLocation(
      double lat, double lon, double alt, double accuracy) async {
    if (_architectWidgetState != null)
  ...
  Future<void> setJSONObjectReceivedCallback(
      OnJSONObjectReceived jsonObjectReceived) async {
  ...
  Future<WikitudeResponse> captureScreen(bool mode, String name) async {
    String captureScreenResponse =
        await _architectWidgetState.captureScreen(mode, name);
    Map<String, dynamic> captureScreenResponseMap =
        jsonDecode(captureScreenResponse);
...
class _ArchitectWidgetState extends State<ArchitectWidget> {
  ...
  _ArchitectWidgetState(String licenseKey,
      StartupConfiguration startConfiguration, List<String> features) {
  ...
  Future<void> setLocation(
    ...
    return _channel.invokeMethod('setLocation',
  ...
  Future<String> captureScreen(bool mode, String name) async {
    ...
    return await _channel
        .invokeMethod('captureScreen', {"mode": mode, "name": name});
  }
